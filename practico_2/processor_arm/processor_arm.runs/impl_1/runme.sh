...
HD_PWD='/media/justyxx/Julian/Vivado/Projects/lab1-adc2025-g01/processor_arm/processor_arm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log processor_arm.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source processor_arm.tcl -notrace
